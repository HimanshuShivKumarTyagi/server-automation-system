...
<%@ page import="java.io.IOException" %>
	...
	<%
        ...
        try
		{
            ...
            File outfile = new File("F://PowerOn.ps1");
            ...
            FileWriter fw = new FileWriter("F://PowerOn.ps1",true);
            ...
            instream.close();
            outstream.close();
            String command = "C:\\WINDOWS\\system32\\WindowsPowerShell\\v1.0\\powershell.exe  \"F:\\PowerOn.ps1\"";
